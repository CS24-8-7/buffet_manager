...
class AppDrawer extends StatelessWidget {
  ...
  Widget _buildDrawerContent(BuildContext context, AuthProvider authProvider, {required bool isDesktop}) {
          ...
          child: ListView(
            ...
            children: [
              ...
              if (isManager) ...[
                ...
                _buildSectionTitle('إدارة النظام', context),
                _buildDrawerItem(
                  context,
                  icon: Icons.inventory,
                  label: 'إدارة المنتجات',
                  route: '/products_management',
                  selected: currentRoute == '/products_management',
                  isDesktop: isDesktop,
                ),
                _buildDrawerItem(
                  context,
                  ...
                  selected: currentRoute == '/users_management',
                  isDesktop: isDesktop,
                ),
                _buildDrawerItem(
                  context,
  ...
  Widget _buildHeader(BuildContext context, AuthProvider authProvider, {required bool isDesktop}) {
    ...
    return Container(
      ...
      child: isDesktop
        ...
        children: [
          ...
          SizedBox(height: ResponsiveHelper.getHeaderSpacing(context) / 2),
          Container(
            padding: ResponsiveHelper.getRoleBadgePadding(context),
            decoration: BoxDecoration(
              color: colorScheme.onSurface.withOpacity(0.3),
              borderRadius: BorderRadius.circular(ResponsiveHelper.getRoleBadgeRadius(context)),
            ),
            child: Text(
  ...
  Widget _buildDrawerItem(
    ...
    return Container(
      ...
      child: ListTile(
        contentPadding: ResponsiveHelper.getDrawerItemPadding(context, isDesktop),
        leading: Icon(
          icon,
        ...
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(ResponsiveHelper.getDrawerItemBorderRadius(context)),
        ),
        onTap: onTap ??
                () {
              if (!isDesktop) {
    ...
    showDialog(
      ...
      builder: (ctx) => CustomLogoutDialog(
        ...
        onLogout: () {
          ...
          Provider.of<AuthProvider>(context, listen: false).logout(); // تسجيل الخروج
          if (kIsWeb) {
  ...
  void _showAboutDialog(BuildContext context) {
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(ResponsiveHelper.getDialogBorderRadius(context)),
        ),
        title: Text(
          'حول التطبيق',
          style: TextStyle(
        ...
        content: SizedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: ResponsiveHelper.getFormFieldSpacing(context) / 2),
              Text(
                'الإصدار: 1.0.0',
                style: TextStyle(
                  fontSize: ResponsiveHelper.getDialogContentFontSize(context),
        ...
        actions: [
          ElevatedButton(
            style: ElevatedButton.styleFrom(
              ...
              shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(ResponsiveHelper.getButtonBorderRadius(context)),
              ),
